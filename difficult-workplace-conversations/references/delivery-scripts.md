...
**Conflict with peer:**
> "I'd like to clear the air about [incident or pattern]. I value our working relationship and want to address this before it affects our collaboration. Can we talk?"
...
> "I need to discuss something personal that's affecting my work. I want to be transparent with you while also keeping some limits. Is now a good time?"
...
When the conversation goes emotional or accusatory:
...
- "Whether or not we agree on what happened, can we agree on [the impact]?"
...
| Instead of | Try |
|---|---|
| "Why did you miss the deadline?" | "Help me understand what happened with the timeline." |
| "You should have told me." | "I would have liked to know earlier. What prevented that?" |

### From Character to Behavior

| Instead of | Try |
|---|---|
| "You're unreliable." | "When deadlines are missed, it creates problems for the team." |
| "You're being difficult." | "I'm having trouble understanding your position. Can you explain?" |

### From Past to Future

| Instead of | Try |
|---|---|
| "You always do this." | "Going forward, how can we handle this differently?" |
| "That presentation was a disaster." | "For the next presentation, let's talk about what would make it stronger." |

### From Positions to Interests

| Instead of | Try |
|---|---|
| "I need you to do X." | "The outcome I'm trying to achieve is Y. What would work for you?" |
| "That won't work for me." | "My concern with that is... What alternatives can we explore?" |
...
> "Let me make sure I understand what we've agreed: [Person A] will [action] by [date]. [Person B] will [action] by [date]. We'll check in on [date]. Does that match your understanding?"
...
> "I'd like to check in on this in [timeframe]. Does [date] work for you?"
...
**The feedback:**
> "In [situation], when [behavior], the impact was [effect]."
...
**The feedback:**
> "When [situation], I find myself [struggling with] because [impact]. I'm wondering if [alternative approach] might work better."
...
**Opening:**
> "I need to bring something to your attention. I've tried to address it directly, and I'm at a point where I need your help."
