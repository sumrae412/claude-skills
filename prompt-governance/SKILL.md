...
- **prompt-optimization**: Use when tuning local explorer/architect/reviewer prompts. Adjacent — prompt-optimization analyzes CourierFlow-internal prompts; prompt-governance manages any production prompt at scale.
