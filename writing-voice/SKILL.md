...
1. **Feel it or don't write it.** Hollow writing is writing that cost nothing
   to produce. Find the angle that makes the subject actually matter.

2. **The dark humor is invisible until it lands.** Deadpan, matter-of-fact
...
3. **Never explain the meaning.** Trust the reader. Show, don't tell. In
...
1. Read aloud in your head — catch anything that doesn't sound like a sentence
   a human would say
