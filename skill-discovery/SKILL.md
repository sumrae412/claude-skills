...
Use [references/matching.md](references/matching.md) for intent-→-skill heuristics and common mis-matches (picking the heavyweight `deep-research` for a single-source docs lookup, etc.).
