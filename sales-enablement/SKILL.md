...
description: "Create sales collateral, pitch decks, one-pagers, objection handling docs, demo scripts, and sales playbooks. Use when the user mentions 'sales deck,' 'pitch deck,' 'one-pager,' 'leave-behind,' 'objection handling,' 'deal-specific ROI analysis,' 'demo script,' 'talk track,' 'sales playbook,' 'proposal template,' 'buyer persona card,' 'help my sales team,' 'sales materials,' or 'what should I give my sales reps.' Use for any document or asset that helps a sales team close deals. Covers deck frameworks, objection libraries, ROI calculators, demo scripts, and proposal templates."
user-invocable: true
---
...
**Output workspace:** Write all sales collateral drafts to `~/Documents/<project>-marketing/` - never inside a tracked git repo. Example: `~/Documents/acme-marketing/sales-deck-outline.md`.

## Before Starting

**Check for product marketing context first:**
If `~/Documents/<project>-marketing/.agents/product-marketing.md` exists (or the legacy paths `.agents/product-marketing.md` or `.claude/product-marketing.md`), read it before asking questions. Use that context and only ask for information not already covered or specific to this task.
...
- `product-marketing` - foundational positioning, ICP, and differentiators
- `copywriting` - marketing website copy and collateral copy
- `pricing` - pricing decisions and packaging for deal proposals
- `storybrand-messaging` - narrative structure for decks and pitches
