...
**PlanCraft's workflow phases** (brainstorming, plan writing, quality gate, involvement modes, execution handoff, docs cleanup) were already superseded by `claude-flow` Phases 1-5 (Phase 3 now split into 3A Requirements Discovery + 3B Edge Cases & Test Planning).
