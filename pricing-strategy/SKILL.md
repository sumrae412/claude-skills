...
description: >
  Use when a founder or PM wants to design or optimize pricing strategy using willingness-to-pay
  research and product-led frameworks. Triggers on: pricing strategy, willingness to pay, WTP
  research, freemium vs paid, self-serve ceiling, pricing model, monetization, price increase,
  value metric. Distinct from the 'pricing' skill (SaaS tiers/packaging); this skill covers
  WTP-research-deep and iteration frameworks from 46 product leaders.
user-invocable: true
---
...
1. **Understand the business model** - ask about their current monetization approach and target
   customer segments.
