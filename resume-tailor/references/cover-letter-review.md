...
## 3. Bridge Paragraph Test

For paragraphs 2 and 3:

1. Name the actual problem or capability the role exists to handle.
2. Show one concrete achievement that solves that problem.
3. Close with why that evidence transfers.
...
- Cliches like "hard worker", "team player", "results-driven"
...
2. All proper nouns by themselves.
3. The closing line by itself.

The first-sentence pass catches candidate-focused openings. The proper-noun pass catches stale company- or role-specific evidence from another letter. The closing-line pass catches filler.
