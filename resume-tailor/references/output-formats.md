...
- **Anti-bragging moves on every body paragraph.** When confidence tips into boasting, four substitutions rescue it: (1) shift subject from "I" to "the work" / "the function" / "the team" where possible (*"I owned the stack"* → *"the stack ran through me"*); (2) use "we" for collective wins — team scaling and platform building are team sports; (3) add humility markers like *"in my experience"* on declarative claims about the work; (4) cut editorializing about your own importance (if a sentence is telling the reader that what you did was important, delete the spin — the fact is stronger alone). See `feedback_cover_letter_eloquent_patterns.md` §1.
- **No comparative put-downs on other candidates.** Never imply other applicants fall short. Ban: *"not just technical depth"*, *"unlike most candidates"*, *"where others stop, I…"*, *"most teams can't, but I…"*. Describe what the work requires without naming a comparison group. Elevation-of-self via demotion-of-others is candidate-focused writing in disguise and it reads as bad manners. See `feedback_cover_letter_eloquent_patterns.md` §2.
...
- **"Shape of work" / "kind of work" / "pattern of work" abstractions in bridge openers.** Constructions like *"X is a particular shape of work"*, *"Y is the kind of work that asks for Z"*, *"Z is a specific pattern"* sound profound but commit to naming no actual problem — the reader walks away thinking *"okay, but WHAT problem?"* Replace with a named pain point. "Shape of work" is a hedging tell; pain-naming is committal and makes the letter stronger. See `feedback_cover_letter_p1_p2_templates.md`.
- **Bald "You need X. I did X" mechanical cadence.** The underlying demand-then-match logic is right, but the surface language *"You need someone who can architect enterprise GenAI. I did that at Govini."* reads as mechanical — it commands the reader about their own needs. Rewrite so the demand is described as a feature of the work, not as an instruction to the reader: *"Enterprise GenAI, in my experience, is less about any single component and more about owning every layer under real constraints. At Govini, that's what the work looked like."* Same match, no finger-pointing. See `feedback_cover_letter_eloquent_patterns.md` §3.
- **Comparative put-downs on other candidates.** Any phrasing that implies other applicants fall short — *"not just technical depth"*, *"unlike most candidates"*, *"where others stop, I…"*, *"most teams can't, but I have"* — is banned. Elevation-of-self via demotion-of-others is candidate-focused writing in disguise. Describe what the work requires without naming a comparison group. See `feedback_cover_letter_eloquent_patterns.md` §2.
- **Restating the JD or quoting it back.** *"Your JD emphasizes X"* / *"The role you describe asks for Y"* / *"Exactly the kind of work this role describes"* / *"Directly addresses the reusable-orchestration ask in this JD"* — all variants of restating the JD back at the reader. They wrote it; answer the ask instead. The right move is the feature-for-[JD-adjacent-purpose] mapping: name a concrete capability, then describe its purpose in vocabulary that echoes the JD without quoting it. See `feedback_cover_letter_eloquent_patterns.md` §4.
